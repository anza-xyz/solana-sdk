...
#[serde_as]
#[derive(Clone, Copy, Debug, Eq, Hash, PartialEq, Deserialize, Serialize, PartialOrd, Ord)]
#[repr(transparent)]
...
#[serde_as]
#[derive(Clone, Copy, Debug, Hash, Eq, PartialEq, Deserialize, Serialize, PartialOrd, Ord)]
#[repr(transparent)]
pub struct Pubkey(
