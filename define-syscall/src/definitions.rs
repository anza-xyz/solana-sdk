...
define_syscall!(#[deprecated(since = "3.0.0", note = "Use `sol_get_sysvar` with epoch schedule sysvar address instead")] fn sol_get_epoch_schedule_sysvar(addr: *mut u8) -> u64);
...
define_syscall!(#[deprecated(since = "3.0.0", note = "Use `sol_get_sysvar` with last restart slot sysvar address instead")] fn sol_get_last_restart_slot(addr: *mut u8) -> u64);
define_syscall!(#[deprecated(since = "3.0.0", note = "Use `sol_get_sysvar` with epoch rewards sysvar address instead")] fn sol_get_epoch_rewards_sysvar(addr: *mut u8) -> u64);
