...
define_syscall!(#[deprecated(since = "3.0.0", note = "Use `sol_get_sysvar` instead")] fn sol_get_clock_sysvar(addr: *mut u8) -> u64);
define_syscall!(#[deprecated(since = "3.0.0", note = "Use `sol_get_sysvar` instead")] fn sol_get_epoch_schedule_sysvar(addr: *mut u8) -> u64);
define_syscall!(#[deprecated(since = "3.0.0", note = "Use `sol_get_sysvar` instead")] fn sol_get_rent_sysvar(addr: *mut u8) -> u64);
define_syscall!(#[deprecated(since = "3.0.0", note = "Use `sol_get_sysvar` instead")] fn sol_get_last_restart_slot(addr: *mut u8) -> u64);
define_syscall!(#[deprecated(since = "3.0.0", note = "Use `sol_get_sysvar` instead")] fn sol_get_epoch_rewards_sysvar(addr: *mut u8) -> u64);
